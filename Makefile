...
QU24-Offline-Editor.o: QU24-Offline-Editor.cpp
	...
	@g++ -Wall -c QU24-Offline-Editor.cpp -Wl,-rpath,/usr/local/lib -l kaitai_struct_cpp_stl_runtime

qu_scene.o: qu_scene.cpp 
	@echo "Compile qu_scene"
	@g++ -Wall -c qu_scene.cpp -Wl,-rpath,/usr/local/lib -l kaitai_struct_cpp_stl_runtime
